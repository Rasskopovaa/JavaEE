    ...
    private static class Handler extends Thread{
        ...
        public void run() {
            ...
            try(Connection connection = new Connection(socket)){
                ...
                sendBroadcastMessage(new Message(clientName, MessageType.USER_ADDED));
            ...
            if (clientName != null) {
                ...
                sendBroadcastMessage(new Message(clientName, MessageType.USER_REMOVED));
            }
        ...
        private void sendListOfUsers(Connection connection, String userName) throws IOException {
            for (String clientName: connectionMap.keySet()){
                if (!clientName.equals(userName))
                    connection.send(new Message(clientName, MessageType.USER_ADDED));
            }
        }
        ...
        private void serverMainLoop(Connection connection, String userName) throws IOException, ClassNotFoundException {
            ...
            while (true){
                ...
                if (message.getType() == MessageType.TEXT){
                    ...
                    sendBroadcastMessage(new Message(messageText, MessageType.TEXT));
                }
                else {
