package Homework.clients;

import Homework.Connection;
import Homework.ConsoleHelper;
import Homework.Message;
import Homework.MessageType;
        ...
        protected void clientHandshake() throws IOException, ClassNotFoundException {
            ...
            while(true){
                ...
                if (message.getType() == MessageType.NAME_REQUEST){
                    ...
                    connection.send(new Message(clientName, MessageType.USER_NAME));
                }
